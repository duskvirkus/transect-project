...
The `/create-a-transect` page SHALL present the transect creation workflow as three ordered steps: Builder, Climate Data, and Analysis.

#### Scenario: Page renders all three steps
- **WHEN** a user navigates to `/create-a-transect`
- **THEN** the page displays three numbered steps: 1) Builder, 2) Climate Data, 3) Analysis, each with a brief description of what that step involves
